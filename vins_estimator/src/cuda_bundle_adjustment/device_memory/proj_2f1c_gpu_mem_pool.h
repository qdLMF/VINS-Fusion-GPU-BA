...
#ifndef CUDA_BA_PROJ_2F1C_GPU_MEM_POOL_H
#define CUDA_BA_PROJ_2F1C_GPU_MEM_POOL_H
...
public :
    ...
    CUDAMatrix2DStatic<T, 9, MAXNUMPROJFACTORS> r_ex;       // 9 = 3 x 3
    CUDAMatrix2DStatic<T, 9, MAXNUMPROJFACTORS> r_ex_trans; // 9 = 3 x 3
...
public :
    ...
    CUDAMatrix2DStatic<T,  2, MAXNUMPROJFACTORS> jacobian_3;           //  2 = 2 x 1 , wrt inv_depth
    CUDAMatrix2DStatic<T,  2, MAXNUMPROJFACTORS> jacobian_4;           //  2 = 2 x 1 , wrt cur_td
    ...
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_03;           //  6 = 6 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_04;           //  6 = 6 x 1 , in Hpp
    ...
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_13;           //  6 = 6 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_14;           //  6 = 6 x 1 , in Hpp
    ...
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_23;           //  6 = 6 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_24;           //  6 = 6 x 1 , in Hpp

    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_30;           //  6 = 1 x 6 , in Hmp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_31;           //  6 = 1 x 6 , in Hmp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_32;           //  6 = 1 x 6 , in Hmp
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> hessian_33;           //  1 = 1 x 1 , in Hmm
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> hessian_34;           //  1 = 1 x 1 , in Hmp

    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_40;           //  6 = 1 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_41;           //  6 = 1 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_42;           //  6 = 1 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> hessian_43;           //  1 = 1 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> hessian_44;           //  1 = 1 x 1 , in Hpp
    ...
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> rhs_3;                //  1 = 1 x 1 , in Bmm
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> rhs_4;                //  1 = 1 x 1 , in Bpp
...
public :
    bool Alloc(const Proj2F1CFactorAllocator<T>& host_array);
};

// ------------------------------------------------------------------------------------------------------------------------

template<typename T, unsigned int MAXNUMPROJFACTORS>
Proj2F1CGPUMemPool<T, MAXNUMPROJFACTORS>::Proj2F1CGPUMemPool() : num_proj_factors(0) {
    ...
    dev_ptr_set.r_ex = r_ex.GetDevRawPtr();
    dev_ptr_set.r_ex_trans = r_ex_trans.GetDevRawPtr();
...
template<typename T, unsigned int MAXNUMPROJFACTORS>
bool Proj2F1CGPUMemPool<T, MAXNUMPROJFACTORS>::Alloc(const Proj2F1CFactorAllocator<T>& host_array) {
    ...
    RETURN_FALSE_IF_CUDA_ERROR(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : pts_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.pts_j,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : pts_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : velocity_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : velocity_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.td_i,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : td_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.td_j,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : td_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.p_i,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : p_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.q_i,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : q_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.p_j,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : p_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.q_j,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : q_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.p_ex_0,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : p_ex_0")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.q_ex_0,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : q_ex_0")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : inv_depth")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.cur_td,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : cur_td")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.idx_i,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : idx_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.idx_j,
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : idx_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : inv_depth_idx")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : inv_depth_idx_for_marg")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : involved_in_marg")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : pose_i_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : pose_j_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : pose_ex_0_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : inv_depth_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F1CGPUMemPool::Alloc() : cur_td_is_fixed")
    );
...
#endif //CUDA_BA_PROJ_2F1C_GPU_MEM_POOL_H
