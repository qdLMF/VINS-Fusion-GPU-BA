...
#ifndef CUDA_BA_PROJ_2F2C_GPU_MEM_POOL_H
#define CUDA_BA_PROJ_2F2C_GPU_MEM_POOL_H

#include "GPUMatrix.h"
#include "../proj_allocators.h"
#include "cuda_error_check.h"
#include "proj_2f2c_dev_ptr_set.h"

namespace VINS_FUSION_CUDA_BA {

template<typename T, unsigned int MAXNUMPROJFACTORS>
class Proj2F2CGPUMemPool {
public :
...
public :
    ...
    CUDAMatrix2DStatic<T, 3, MAXNUMPROJFACTORS> p_i;
    CUDAMatrix2DStatic<T, 4, MAXNUMPROJFACTORS> q_i;
    CUDAMatrix2DStatic<T, 3, MAXNUMPROJFACTORS> p_j;
    CUDAMatrix2DStatic<T, 4, MAXNUMPROJFACTORS> q_j;
    ...
    CUDAMatrix2DStatic<char, 1, MAXNUMPROJFACTORS> pose_i_is_fixed;
    CUDAMatrix2DStatic<char, 1, MAXNUMPROJFACTORS> pose_j_is_fixed;
...
public :
    ...
    CUDAMatrix2DStatic<T, 3, MAXNUMPROJFACTORS> pts_world;
    ...
    CUDAMatrix2DStatic<T, 9, MAXNUMPROJFACTORS> r_i;            // 9 = 3 x 3
    CUDAMatrix2DStatic<T, 9, MAXNUMPROJFACTORS> r_i_trans;      // 9 = 3 x 3
    CUDAMatrix2DStatic<T, 9, MAXNUMPROJFACTORS> r_j;            // 9 = 3 x 3
    CUDAMatrix2DStatic<T, 9, MAXNUMPROJFACTORS> r_j_trans;      // 9 = 3 x 3
    ...
    CUDAMatrix2DStatic<T, 9, MAXNUMPROJFACTORS> tmp_r_2;        // 9 = 3 x 3
...
public :
    ...
    CUDAMatrix2DStatic<T, 12, MAXNUMPROJFACTORS> jacobian_0;           // 12 = 2 x 6 , wrt p_i, q_i
    CUDAMatrix2DStatic<T, 12, MAXNUMPROJFACTORS> jacobian_1;           // 12 = 2 x 6 , wrt p_j, q_j
    CUDAMatrix2DStatic<T, 12, MAXNUMPROJFACTORS> jacobian_2;           // 12 = 2 x 6 , wrt p_ex_0, q_ex_0
    CUDAMatrix2DStatic<T, 12, MAXNUMPROJFACTORS> jacobian_3;           // 12 = 2 x 6 , wrt p_ex_1, q_ex_1
    CUDAMatrix2DStatic<T,  2, MAXNUMPROJFACTORS> jacobian_4;           //  2 = 2 x 1 , wrt inv_depth
    CUDAMatrix2DStatic<T,  2, MAXNUMPROJFACTORS> jacobian_5;           //  2 = 2 x 1 , wrt cur_td
    ...
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_02;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_03;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_04;           //  6 = 6 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_05;           //  6 = 6 x 1 , in Hpp
    ...
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_12;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_13;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_14;           //  6 = 6 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_15;           //  6 = 6 x 1 , in Hpp

    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_20;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_21;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_22;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_23;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_24;           //  6 = 6 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_25;           //  6 = 6 x 1 , in Hpp

    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_30;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_31;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_32;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T, 36, MAXNUMPROJFACTORS> hessian_33;           // 36 = 6 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_34;           //  6 = 6 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_35;           //  6 = 6 x 1 , in Hpp

    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_40;           //  6 = 1 x 6 , in Hmp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_41;           //  6 = 1 x 6 , in Hmp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_42;           //  6 = 1 x 6 , in Hmp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_43;           //  6 = 1 x 6 , in Hmp
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> hessian_44;           //  1 = 1 x 1 , in Hmm
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> hessian_45;           //  1 = 1 x 1 , in Hmp

    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_50;           //  6 = 1 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_51;           //  6 = 1 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_52;           //  6 = 1 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> hessian_53;           //  6 = 1 x 6 , in Hpp
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> hessian_54;           //  1 = 1 x 1 , in Hpm
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> hessian_55;           //  1 = 1 x 1 , in Hpp
    ...
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> rhs_2;                //  6 = 6 x 1 , in Bpp
    // CUDAMatrix2DStatic<T,  6, MAXNUMPROJFACTORS> rhs_3;                //  6 = 6 x 1 , in Bpp
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> rhs_4;                //  1 = 1 x 1 , in Bmm
    // CUDAMatrix2DStatic<T,  1, MAXNUMPROJFACTORS> rhs_5;                //  1 = 1 x 1 , in Bpp
...
public :
    ...
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_04_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_04_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_05_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_05_col_start;
    ...
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_14_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_14_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_15_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_15_col_start;
    ...
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_24_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_24_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_25_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_25_col_start;
    ...
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_34_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_34_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_35_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_35_col_start;

    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_40_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_40_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_41_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_41_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_42_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_42_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_43_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_43_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_44_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_44_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_45_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_45_col_start;

    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_50_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_50_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_51_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_51_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_52_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_52_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_53_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_53_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_54_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_54_col_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_55_row_start; CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> hessian_55_col_start;
    ...
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> rhs_4_row_start;
    CUDAMatrix2DStatic<unsigned int, 1, MAXNUMPROJFACTORS> rhs_5_row_start;

public :
    Proj2F2CGPUMemPool();

public :
    bool Alloc(const Proj2F2CFactorAllocator<T>& host_array);
};

template<typename T, unsigned int MAXNUMPROJFACTORS>
Proj2F2CGPUMemPool<T, MAXNUMPROJFACTORS>::Proj2F2CGPUMemPool() : num_proj_factors(0) {
    ...
    dev_ptr_set.pts_world = pts_world.GetDevRawPtr();
    ...
    dev_ptr_set.r_i = r_i.GetDevRawPtr();
    dev_ptr_set.r_i_trans = r_i_trans.GetDevRawPtr();
    dev_ptr_set.r_j = r_j.GetDevRawPtr();
    dev_ptr_set.r_j_trans = r_j_trans.GetDevRawPtr();
    ...
    dev_ptr_set.tmp_r_2 = tmp_r_2.GetDevRawPtr();
    ...
    dev_ptr_set.jacobian_4 = jacobian_4.GetDevRawPtr();
    dev_ptr_set.jacobian_5 = jacobian_5.GetDevRawPtr();
    ...
    // dev_ptr_set.hessian_04 = hessian_04.GetDevRawPtr();
    // dev_ptr_set.hessian_05 = hessian_05.GetDevRawPtr();
    ...
    // dev_ptr_set.hessian_14 = hessian_14.GetDevRawPtr();
    // dev_ptr_set.hessian_15 = hessian_15.GetDevRawPtr();
    ...
    // dev_ptr_set.hessian_24 = hessian_24.GetDevRawPtr();
    // dev_ptr_set.hessian_25 = hessian_25.GetDevRawPtr();
    ...
    // dev_ptr_set.hessian_34 = hessian_34.GetDevRawPtr();
    // dev_ptr_set.hessian_35 = hessian_35.GetDevRawPtr();

    // dev_ptr_set.hessian_40 = hessian_40.GetDevRawPtr();
    // dev_ptr_set.hessian_41 = hessian_41.GetDevRawPtr();
    // dev_ptr_set.hessian_42 = hessian_42.GetDevRawPtr();
    // dev_ptr_set.hessian_43 = hessian_43.GetDevRawPtr();
    // dev_ptr_set.hessian_44 = hessian_44.GetDevRawPtr();
    // dev_ptr_set.hessian_45 = hessian_45.GetDevRawPtr();

    // dev_ptr_set.hessian_50 = hessian_50.GetDevRawPtr();
    // dev_ptr_set.hessian_51 = hessian_51.GetDevRawPtr();
    // dev_ptr_set.hessian_52 = hessian_52.GetDevRawPtr();
    // dev_ptr_set.hessian_53 = hessian_53.GetDevRawPtr();
    // dev_ptr_set.hessian_54 = hessian_54.GetDevRawPtr();
    // dev_ptr_set.hessian_55 = hessian_55.GetDevRawPtr();
    ...
    // dev_ptr_set.rhs_4 = rhs_4.GetDevRawPtr();
    // dev_ptr_set.rhs_5 = rhs_5.GetDevRawPtr();
    ...
    dev_ptr_set.hessian_04_row_start = hessian_04_row_start.GetDevRawPtr(); dev_ptr_set.hessian_04_col_start = hessian_04_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_05_row_start = hessian_05_row_start.GetDevRawPtr(); dev_ptr_set.hessian_05_col_start = hessian_05_col_start.GetDevRawPtr();
    ...
    dev_ptr_set.hessian_14_row_start = hessian_14_row_start.GetDevRawPtr(); dev_ptr_set.hessian_14_col_start = hessian_14_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_15_row_start = hessian_15_row_start.GetDevRawPtr(); dev_ptr_set.hessian_15_col_start = hessian_15_col_start.GetDevRawPtr();
    ...
    dev_ptr_set.hessian_24_row_start = hessian_24_row_start.GetDevRawPtr(); dev_ptr_set.hessian_24_col_start = hessian_24_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_25_row_start = hessian_25_row_start.GetDevRawPtr(); dev_ptr_set.hessian_25_col_start = hessian_25_col_start.GetDevRawPtr();
    ...
    dev_ptr_set.hessian_34_row_start = hessian_34_row_start.GetDevRawPtr(); dev_ptr_set.hessian_34_col_start = hessian_34_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_35_row_start = hessian_35_row_start.GetDevRawPtr(); dev_ptr_set.hessian_35_col_start = hessian_35_col_start.GetDevRawPtr();

    dev_ptr_set.hessian_40_row_start = hessian_40_row_start.GetDevRawPtr(); dev_ptr_set.hessian_40_col_start = hessian_40_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_41_row_start = hessian_41_row_start.GetDevRawPtr(); dev_ptr_set.hessian_41_col_start = hessian_41_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_42_row_start = hessian_42_row_start.GetDevRawPtr(); dev_ptr_set.hessian_42_col_start = hessian_42_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_43_row_start = hessian_43_row_start.GetDevRawPtr(); dev_ptr_set.hessian_43_col_start = hessian_43_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_44_row_start = hessian_44_row_start.GetDevRawPtr(); dev_ptr_set.hessian_44_col_start = hessian_44_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_45_row_start = hessian_45_row_start.GetDevRawPtr(); dev_ptr_set.hessian_45_col_start = hessian_45_col_start.GetDevRawPtr();

    dev_ptr_set.hessian_50_row_start = hessian_50_row_start.GetDevRawPtr(); dev_ptr_set.hessian_50_col_start = hessian_50_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_51_row_start = hessian_51_row_start.GetDevRawPtr(); dev_ptr_set.hessian_51_col_start = hessian_51_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_52_row_start = hessian_52_row_start.GetDevRawPtr(); dev_ptr_set.hessian_52_col_start = hessian_52_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_53_row_start = hessian_53_row_start.GetDevRawPtr(); dev_ptr_set.hessian_53_col_start = hessian_53_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_54_row_start = hessian_54_row_start.GetDevRawPtr(); dev_ptr_set.hessian_54_col_start = hessian_54_col_start.GetDevRawPtr();
    dev_ptr_set.hessian_55_row_start = hessian_55_row_start.GetDevRawPtr(); dev_ptr_set.hessian_55_col_start = hessian_55_col_start.GetDevRawPtr();
    ...
    dev_ptr_set.rhs_4_row_start = rhs_4_row_start.GetDevRawPtr();
    dev_ptr_set.rhs_5_row_start = rhs_5_row_start.GetDevRawPtr();
}

// ------------------------------------------------------------------------------------------------------------------------

template<typename T, unsigned int MAXNUMPROJFACTORS>
bool Proj2F2CGPUMemPool<T, MAXNUMPROJFACTORS>::Alloc(const Proj2F2CFactorAllocator<T>& host_array) {
    ...
    RETURN_FALSE_IF_CUDA_ERROR(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : pts_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.pts_j,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : pts_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : velocity_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : velocity_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.td_i,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : td_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.td_j,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : td_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.p_i,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : p_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.q_i,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : q_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.p_j,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : p_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.q_j,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : q_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.p_ex_0,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : p_ex_0")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.q_ex_0,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : q_ex_0")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.p_ex_1,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : p_ex_1")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.q_ex_1,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : q_ex_1")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : inv_depth")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.cur_td,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : cur_td")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.idx_i,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : idx_i")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
            dev_ptr_set.idx_j,
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : idx_j")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : inv_depth_idx")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : inv_depth_idx_for_marg")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : involved_in_marg")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : pose_i_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : pose_j_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : pose_ex_0_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : pose_ex_1_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : inv_depth_is_fixed")
    );
    RETURN_FALSE_IF_CUDA_ERROR(
        cudaMemcpy(
        ...
        std::string("ALLOC ERROR in Proj2F2CGPUMemPool::Alloc() : cur_td_is_fixed")
    );
...
#endif //CUDA_BA_PROJ_2F2C_GPU_MEM_POOL_H
