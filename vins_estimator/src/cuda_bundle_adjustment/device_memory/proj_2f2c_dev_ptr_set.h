...
#ifndef CUDA_BA_PROJ_2F2C_DEV_PTR_SET_H
#define CUDA_BA_PROJ_2F2C_DEV_PTR_SET_H

namespace VINS_FUSION_CUDA_BA {

template<typename T>
class Proj2F2CFactorDevPtrSet {
public :
    // input
    ...
    T* jacobian_3 = nullptr;           // num_projection_factors * 12 = 2 x 6 , wrt p_ex_1, q_ex_1
    T* jacobian_4 = nullptr;           // num_projection_factors *  2 = 1 x 1 , wrt inv_depth
    T* jacobian_5 = nullptr;           // num_projection_factors *  2 = 1 x 1 , wrt cur_td
    ...
    // T* hessian_03 = nullptr;           // num_projection_factors * 36 = 6 x 6 , in Hpp
    // T* hessian_04 = nullptr;           // num_projection_factors *  6 = 6 x 1 , in Hpm
    // T* hessian_05 = nullptr;           // num_projection_factors *  6 = 6 x 1 , in Hpp
    ...
    // T* hessian_13 = nullptr;           // num_projection_factors * 36 = 6 x 6 , in Hpp
    // T* hessian_14 = nullptr;           // num_projection_factors *  6 = 6 x 1 , in Hpm
    // T* hessian_15 = nullptr;           // num_projection_factors *  6 = 6 x 1 , in Hpp
    ...
    // T* hessian_23 = nullptr;           // num_projection_factors * 36 = 6 x 6 , in Hpp
    // T* hessian_24 = nullptr;           // num_projection_factors *  6 = 6 x 1 , in Hpm
    // T* hessian_25 = nullptr;           // num_projection_factors *  6 = 6 x 1 , in Hpp
    // T* hessian_30 = nullptr;           // num_projection_factors * 36 = 6 x 6 , in Hpp
    // T* hessian_31 = nullptr;           // num_projection_factors * 36 = 6 x 6 , in Hpp
    // T* hessian_32 = nullptr;           // num_projection_factors * 36 = 6 x 6 , in Hpp
    // T* hessian_33 = nullptr;           // num_projection_factors * 36 = 6 x 6 , in Hpp
    // T* hessian_34 = nullptr;           // num_projection_factors *  6 = 6 x 1 , in Hpm
    // T* hessian_35 = nullptr;           // num_projection_factors *  6 = 6 x 1 , in Hpp
    // T* hessian_40 = nullptr;           // num_projection_factors *  6 = 1 x 6 , in Hmp
    // T* hessian_41 = nullptr;           // num_projection_factors *  6 = 1 x 6 , in Hmp
    // T* hessian_42 = nullptr;           // num_projection_factors *  6 = 1 x 6 , in Hmp
    // T* hessian_43 = nullptr;           // num_projection_factors *  6 = 1 x 6 , in Hmp
    // T* hessian_44 = nullptr;           // num_projection_factors *  1 = 1 x 1 , in Hmm
    // T* hessian_45 = nullptr;           // num_projection_factors *  1 = 1 x 1 , in Hmp
    // T* hessian_50 = nullptr;           // num_projection_factors *  6 = 1 x 6 , in Hpp
    // T* hessian_51 = nullptr;           // num_projection_factors *  6 = 1 x 6 , in Hpp
    // T* hessian_52 = nullptr;           // num_projection_factors *  6 = 1 x 6 , in Hpp
    // T* hessian_53 = nullptr;           // num_projection_factors *  6 = 1 x 6 , in Hpp
    // T* hessian_54 = nullptr;           // num_projection_factors *  1 = 1 x 1 , in Hpm
    // T* hessian_55 = nullptr;           // num_projection_factors *  1 = 1 x 1 , in Hpp
    ...
    // T* rhs_3 = nullptr;                // num_projection_factors *  6 = 6 x 1 , in Bpp
    // T* rhs_4 = nullptr;                // num_projection_factors *  1 = 1 x 1 , in Bmm
    // T* rhs_5 = nullptr;                // num_projection_factors *  1 = 1 x 1 , in Bpp
    ...
    unsigned int* hessian_04_row_start = nullptr; unsigned int* hessian_04_col_start = nullptr;
    unsigned int* hessian_05_row_start = nullptr; unsigned int* hessian_05_col_start = nullptr;
    ...
    unsigned int* hessian_14_row_start = nullptr; unsigned int* hessian_14_col_start = nullptr;
    unsigned int* hessian_15_row_start = nullptr; unsigned int* hessian_15_col_start = nullptr;
    ...
    unsigned int* hessian_24_row_start = nullptr; unsigned int* hessian_24_col_start = nullptr;
    unsigned int* hessian_25_row_start = nullptr; unsigned int* hessian_25_col_start = nullptr;
    ...
    unsigned int* hessian_34_row_start = nullptr; unsigned int* hessian_34_col_start = nullptr;
    unsigned int* hessian_35_row_start = nullptr; unsigned int* hessian_35_col_start = nullptr;

    unsigned int* hessian_40_row_start = nullptr; unsigned int* hessian_40_col_start = nullptr;
    unsigned int* hessian_41_row_start = nullptr; unsigned int* hessian_41_col_start = nullptr;
    unsigned int* hessian_42_row_start = nullptr; unsigned int* hessian_42_col_start = nullptr;
    unsigned int* hessian_43_row_start = nullptr; unsigned int* hessian_43_col_start = nullptr;
    unsigned int* hessian_44_row_start = nullptr; unsigned int* hessian_44_col_start = nullptr;
    unsigned int* hessian_45_row_start = nullptr; unsigned int* hessian_45_col_start = nullptr;

    unsigned int* hessian_50_row_start = nullptr; unsigned int* hessian_50_col_start = nullptr;
    unsigned int* hessian_51_row_start = nullptr; unsigned int* hessian_51_col_start = nullptr;
    unsigned int* hessian_52_row_start = nullptr; unsigned int* hessian_52_col_start = nullptr;
    unsigned int* hessian_53_row_start = nullptr; unsigned int* hessian_53_col_start = nullptr;
    unsigned int* hessian_54_row_start = nullptr; unsigned int* hessian_54_col_start = nullptr;
    unsigned int* hessian_55_row_start = nullptr; unsigned int* hessian_55_col_start = nullptr;
    ...
    unsigned int* rhs_5_row_start = nullptr;
...
#endif //CUDA_BA_PROJ_2F2C_DEV_PTR_SET_H
